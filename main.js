...
!(function (t) {
                    ...
                    e.forEach(function (t) {
                        ...
                        window.MutationObserver &&
                            addEventListener("DOMContentLoaded", function () {
                                new MutationObserver(o).observe(document.body, { attributes: !0, childList: !0, subtree: !0 });
                            });
                    var u = function (t) {
                        if ("string" == typeof t) {
    ...
    function (t, e) {
        ...
        function n(t, e) {
            var n = t.getBoundingClientRect(),
                ...
                f = n.width,
                s = n.height,
                c = { t: i, r: window.innerWidth - u, b: window.innerHeight - r, l: o },
    ...
    function (t, e, n) {
        function r(t, e, n) {
            ...
            return i(n) && ((r = "leading" in n ? !!n.leading : r), (f = "trailing" in n ? !!n.trailing : f)), o(t, e, { leading: r, maxWait: e, trailing: f });
        }
        var o = n(8),
            i = n(1),
...
let lenis;
let useLenis = window.innerWidth >= 1024;
...
document.addEventListener("DOMContentLoaded", function () {
    if (useLenis) {
        ...
        // hlavní raf pro Lenis + Sync se ScrollTrigger
        function raf(time) {
            lenis.raf(time);
    ...
    // waypoint animace benefits boxů
    $(document).ready(function () {
        $('.benefits').waypoint({
            offset: 0,
            onEnter: function () { $(this).addClass("benefits--1"); },
            onExit: function () { $(this).removeClass("benefits--1"); },
        });
        $('.benefits').waypoint({
            offset: 33,
            onEnter: function () { $(this).addClass("benefits--2"); },
            onExit: function () { $(this).removeClass("benefits--2"); },
        });
        $('.benefits').waypoint({
            offset: 66,
            onEnter: function () { $(this).addClass("benefits--3"); },
            onExit: function () { $(this).removeClass("benefits--3"); },
        });
    });
...
function initJumboScene() {
    if (!document.querySelector('.jumbo')) return;

    if (typeof gsap === 'undefined' || typeof ScrollTrigger === 'undefined') {
        console.warn('GSAP / ScrollTrigger není načtený');
        return;
    }

    gsap.registerPlugin(ScrollTrigger);

    // pouze pokud používáme Lenis
    if (useLenis && lenis) {
    ...
    const canvasEl = document.querySelector('.jumbo__canvas');
    const videoEl = document.querySelector('.jumbo__video');
    const svgEl = document.querySelector('.jumbo__box svg');
    const titleEl = document.querySelector('.jumbo__title');
    ...
    if (titleEl) {
        gsap.set(titleEl, { marginTop: '26rem' });
        gsap.to(titleEl, {
            marginTop: '14rem',
            ease: 'power2.inOut',
            scrollTrigger: {
    ...
    if (svgEl) {
        requestAnimationFrame(function() {
            ...
            gsap.set(svgEl, {
                ...
                width: svgWidth + 'px',
                fill: computedFill,
                willChange: 'top,left,width,fill'
            });
...
// přidáme listener na resize pro přepínání režimu
window.addEventListener('resize', () => {
    const shouldUseLenis = window.innerWidth >= 1024;
    if (shouldUseLenis !== useLenis) {
        location.reload(); // jednoduché řešení – reloadne stránku při změně režimu
    }
});
...
function handleHeaderChange() {
  setInterval(function() {
    ...
    if (userHasScrolled && (window.scrollY > 1800 || window.pageYOffset > 1800)) {
